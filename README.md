...
In this particular study, you will answer questions on style preferences. There are two survey version for it - a classical one and a chat one. We would like you to test both of them by answering the surveys in the way you would in a real world setting. When you have finished a survey, there will be meta questions on the survey on which we ask for your impression. Then you should take the other survey version, respectively. Don't worry, links will guide you through the whole procedure. Total completion time should be no more than 10 min.
